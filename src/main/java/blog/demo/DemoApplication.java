...
public class DemoApplication {
     ...
     */
    @Autowired
    public void authenticationManager(AuthenticationManagerBuilder builder, UserRepo repository, UserService userService) throws Exception {
